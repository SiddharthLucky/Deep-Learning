...
# Predicting if a customer is going  to leave the bank, basing on the given criteria,
# Trying to make a single value prediction.
"""
Predicting the values of customers with input given this way, predict one single customer info
Geography: france
Credit Score: 600
Gender: Male
Age: 40
...
For this, compare the labelled values in the dataset and the values in the X table ie before labelling
The matrix can be expanded using multiple arrays but they have to be a 2D array
"""
